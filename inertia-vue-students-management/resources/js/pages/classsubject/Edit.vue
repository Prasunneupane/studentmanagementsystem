...
const form = useForm({
  class_id: props.classes.find(c => c.value === props.classSubject.class_id) || null,
  section_id: props.sections.find(s => s.value === props.classSubject.section_id) || null,
  subject_id: props.subjects.find(s => s.value === props.classSubject.subject_id) || null,
  teacher_id: props.classSubject.teacher_id 
    ? props.teachers.find(t => t.value === props.classSubject.teacher_id) || null 
    : null,
  academic_year_id: props.academicYears.find(y => y.value === props.classSubject.academic_year_id) || null,
