            ...
            <Card>
                <CardHeader class="flex flex-row items-center justify-between">
                    ...
                    <Button v-if="can('users.canView')" as-child>
                        <Link :href="route('users.index')"> <Eye class="mr-2 h-4 w-4" /> View User </Link>
                    </Button>
                </CardHeader>
                ...
                <InputError :message="form.errors.password" />
                            ...
                            <div class="space-y-2">
                                ...
                                <SelectSearch
                                    :tabindex="5"
                                    :model-value="statusOptions.find((r) => r.value === form.roles) || null"
                        ...
                        <div class="flex justify-end gap-4 border-t pt-6" v-if="can('users.canCreate') || can('users.canEdit')">
