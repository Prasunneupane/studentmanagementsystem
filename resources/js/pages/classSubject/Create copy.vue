...
// Helper function to extract value from option object or return the value itself
...
const handleSubmit = () => {
    ...
    form.transform((data) => ({
        ...
        subject_id: extractValue(data.subject_id),
        ...
        <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl p-4">
            <Card class="w-full rounded-2xl shadow-lg">
                <CardHeader class="border-b">
                    ...
                    <p class="mt-1 text-sm text-muted-foreground">Configure subject assignment, teacher allocation, and grading parameters</p>
                </CardHeader>
                ...
                <CardContent class="pt-6">
                    <form @submit.prevent="handleSubmit" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                            <div class="space-y-2">
                                <Label for="subject_id"> Subject <span class="text-red-500">*</span> </Label>
                                <CustomSelect
                                    id="subject_id"
                            ...
                            <div class="space-y-2">
                                ...
                                <SelectSearch id="teacher_id" v-model="form.teacher_id" :options="teachers" placeholder="Select Teacher" />
                                <p class="text-xs text-muted-foreground">Leave empty if teacher not yet assigned</p>
                            </div>
                        </div>

                        <!-- Configuration -->
                        <div class="space-y-4 rounded-lg bg-muted/50 p-4">
                            <h3 class="text-sm font-semibold">Subject Configuration</h3>
                            ...
                            <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                                ...
                                <div class="space-y-2">
                                    <Label for="max_marks"> Maximum Marks <span class="text-red-500">*</span> </Label>
                                    <Input
                                        id="max_marks"
                                ...
                                <div class="space-y-2">
                                    <Label for="pass_marks"> Pass Marks <span class="text-red-500">*</span> </Label>
                                    <Input
                                        id="pass_marks"
                            ...
                            <div class="flex items-center space-x-2">
                                <Checkbox id="is_optional" v-model:checked="form.is_optional" />
                                <Label for="is_optional" class="cursor-pointer font-normal"> This is an optional/elective subject </Label>
                            </div>
                        </div>
