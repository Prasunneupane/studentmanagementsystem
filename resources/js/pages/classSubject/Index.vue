...
import { Edit, Filter, Plus, Trash2 } from 'lucide-vue-next';
...
const breadcrumbs = [{ title: 'Class Subjects', href: '/class-subjects' }];
        ...
        <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl p-4">
                ...
                <CardHeader>
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="mt-1 text-sm text-muted-foreground">Manage subject-teacher assignments for classes</p>
                        </div>
            ...
            <Card class="w-full rounded-2xl shadow-lg">
                <CardContent class="pt-6">
                    <DataTable :columns="columns" :data="filteredAssignments" :loading="false" title="Subject Assignments" />
                </CardContent>
            </Card>
        </div>
    </AppLayout>
            ...
            <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                    ...
                    <div v-if="assignmentToDelete" class="mt-3 rounded-md border border-red-200 bg-red-50 p-3 text-sm">
                        <strong>{{ assignmentToDelete.subject_name }}</strong
                        ><br />
