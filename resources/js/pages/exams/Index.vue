    ...
    <div class="min-h-screen bg-gray-50">
        <div class="container mx-auto px-4 py-8">
            ...
            <div class="mb-8">
                ...
                <p class="mt-2 text-gray-600">Manage and view all exams</p>
            </div>

            <!-- Stats Cards -->
            <div class="mb-8 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
            ...
            <!-- Exam Cards Grid -->
            <div v-if="exams.data.length > 0" class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                <ExamCard v-for="exam in exams.data" :key="exam.id" :exam="exam" @view="viewExam" />
            </div>

            <div v-else class="rounded-lg bg-white p-12 text-center shadow-sm">
                <Calendar class="mx-auto mb-4 h-12 w-12 text-gray-400" />
                <h3 class="mb-2 text-lg font-medium text-gray-900">No exams found</h3>
            ...
            <div v-if="exams.last_page > 1" class="mt-8 flex justify-center">
                <Pagination :current-page="exams.current_page" :last-page="exams.last_page" @page-change="changePage" />
            </div>
        </div>
    </div>
</template>
