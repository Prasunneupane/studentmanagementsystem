            ...
            <Card>
                <CardHeader>
                    <CardTitle>
                        ...
                        <Button v-if="can('terms.canView')" as-child class="float-right ml-auto">
                            <Link :href="route('terms.index')"> <Eye class="mr-2 h-4 w-4" /> View Terms </Link>
                        </Button>
                    </CardTitle>
                    ...
                    <form @submit.prevent="handleSubmit" class="space-y-8">
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                            <div class="space-y-2">
                                ...
                                <CustomSelect v-model="form.academic_year_id" :options="academicYears" placeholder="Select Academic Year" />
                        ...
                        <!-- Actions -->
                        <div class="flex justify-end gap-4 border-t pt-6" v-if="can('terms.canCreate') || can('terms.canEdit')">
