...
import { Edit, Loader2, Mail, Phone, Plus, Trash2, User } from 'lucide-vue-next';
    ...
    <div class="space-y-4">
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-600">Manage guardians for {{ studentName }}</p>
            </div>
                        ...
                        <TableBody>
                            ...
                            <TableRow v-else v-for="guardian in guardians" :key="guardian.id" class="hover:bg-gray-50">
                                ...
                                <TableCell class="text-center">
                                    <Badge v-if="guardian.is_primary_contact" variant="default" class="text-xs"> Primary </Badge>
                                    <span v-else class="text-sm text-gray-400">—</span>
                                </TableCell>
        ...
        <!-- Guardian Form Modal -->
        <GuardianFormModal v-model:open="isFormModalOpen" :student-id="studentId" :guardian="selectedGuardian" @saved="handleGuardianSaved" />

        <!-- Delete Confirmation Dialog -->
        <GuardianDeleteDialog v-model:open="isDeleteDialogOpen" :guardian="guardianToDelete" @deleted="handleGuardianDeleted" />
    </div>
</template>
