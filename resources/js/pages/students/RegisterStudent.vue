...
const { validationErrors, showValidation, validateField, validateGuardianField, validateAllFields } = useFormValidation(form);

const { states, districts, municipalities, isDistrictLoading, isMunicipalityLoading, ...locationHandlers } = useLocationData(
    form,
    props.stateList,
    props.districtList,
