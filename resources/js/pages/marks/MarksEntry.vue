...
const filteredIndices = computed(() => {
    ...
    return props.students.reduce<number[]>((acc, s, i) => {
        if (s.name.toLowerCase().includes(q) || s.roll_no.toLowerCase().includes(q)) acc.push(i);
        return acc;
    }, []);
});
        ...
        autoTable(doc, {
            ...
            head: [
                [
                    ...
                    'Roll',
                    'Name',
                    `Theory (${maxTheory.value})`,
                    `Practical (${maxPractical.value})`,
    ...
    try {
        const rows = [
            ...
            [
                ...
                'Roll No',
                'Student Name',
                `Theory (Max ${maxTheory.value})`,
                `Practical (Max ${maxPractical.value})`,
                `Total (Max ${maxTotal.value})`,
                'Status',
                'Remarks',
            ],
                    ...
                    <div class="flex flex-wrap items-center justify-between gap-3">
                        ...
                        <div class="flex flex-wrap items-center gap-2">
                            ...
                            <div class="relative">
                                ...
                                <Input v-model="searchQuery" placeholder="Search name or roll no..." class="h-8 w-52 pl-8 text-xs" />
                            </div>
                        ...
                        <table class="w-full text-sm">
                            <thead>
                                <tr class="border-b bg-muted/60">
                                    ...
                                    <th class="w-16 px-4 py-3 text-left font-semibold text-muted-foreground">Roll</th>
                                    <th class="min-w-[200px] px-4 py-3 text-left font-semibold text-muted-foreground">Student Name</th>
                                    <th class="w-28 px-4 py-3 text-center font-semibold text-muted-foreground">
                                    ...
                                    <th class="w-24 px-4 py-3 text-center font-semibold text-muted-foreground">Total</th>
                                    <th class="w-16 px-4 py-3 text-center font-semibold text-muted-foreground">Absent</th>
                                    <th class="w-40 px-4 py-3 text-left font-semibold text-muted-foreground">Remarks</th>
                                </tr>
                            </thead>
                            <tbody>
                                <!-- Paginated rows -->
                                    ...
                                    <td class="px-3 py-2.5">
                                        <div>
                                            <Input
                                                ...
                                                @update:model-value="
                                                    (v) => {
                                                        marks[origIndex].theory_marks = String(v);
                                                        onMarkChange(origIndex);
                                                    }
                                                "
                                                ...
                                                :tabindex="rowPos * 3 + 1"
                                            />
                                            <p v-if="marks[origIndex].error_theory" class="mt-0.5 text-center text-[10px] text-red-500">
                                    ...
                                    <td class="px-3 py-2.5">
                                        <div>
                                            <Input
                                                ...
                                                @update:model-value="
                                                    (v) => {
                                                        marks[origIndex].practical_marks = String(v);
                                                        onMarkChange(origIndex);
                                                    }
                                                "
                                                class="h-8 text-center text-xs"
                                                ...
                                                :tabindex="rowPos * 3 + 2"
                                            />
                                            <p v-if="marks[origIndex].error_practical" class="mt-0.5 text-center text-[10px] text-red-500">
