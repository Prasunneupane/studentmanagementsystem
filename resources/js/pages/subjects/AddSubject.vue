...
const form = useForm({
    ...
    type: props.subject ? { value: props.subject.type, label: formatType(props.subject.type) } : defaultSubjectType,
            ...
            <Card>
                <CardHeader>
                    <CardTitle>
                        ...
                        <Button v-if="can('subjects.canView')" as-child class="float-right ml-auto">
                            <Link :href="route('subjects.index')"> <Eye class="mr-2 h-4 w-4" /> View Subjects </Link>
                        </Button>
                    </CardTitle>
                    ...
                    <form @submit.prevent="handleSubmit" class="space-y-8">
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                            <div class="space-y-2">
                                ...
                                <SelectSearch v-model="form.type" :options="sections" placeholder="Select subject type" />
                        ...
                        <!-- Actions -->
                        <div class="flex justify-end gap-4 border-t pt-6" v-if="can('subjects.canCreate') || can('subjects.canEdit')">
