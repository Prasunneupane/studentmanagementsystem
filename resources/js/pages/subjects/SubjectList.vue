        ...
        cell: ({ row }) => {
            ...
            return h('div', { class: 'flex items-center gap-2' }, [
                can('subjects.canEdit') &&
                    h(
                        Button,
                        { variant: 'ghost', size: 'sm', class: 'h-8 w-8 p-0 cursor-pointer', title: 'Edit', onClick: () => handleEdit(subject) },
            ...
            <Card class="w-full rounded-2xl shadow-lg">
                <CardHeader>
                    <CardTitle class="text-xl font-bold">
                        Subject List
                        <Button v-if="can('subjects.canCreate')" as-child class="float-right ml-auto">
