...
const FormField = defineComponent({
    ...
    setup(props, { slots }) {
        return () =>
            h('div', { class: 'space-y-2', id: props.id }, [
                h(Label, { for: props.id }, [props.label, props.required && h('span', { class: 'text-red-500' }, '*')]),
                slots.default?.(),
    ...
    <form @submit.prevent="$emit('submit')" class="space-y-6">
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
            ...
            <div class="space-y-2" id="fName">
                ...
                />
                <p v-if="validationErrors.fName" class="mt-1 text-sm text-red-600">
            ...
            <div class="space-y-2" id="lName">
                ...
                />
                <p v-if="validationErrors.lName" class="mt-1 text-sm text-red-600">
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
            ...
            <div class="space-y-2" id="age">
                ...
                />
                <p v-if="validationErrors.age" class="mt-1 text-sm text-red-600">
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
            ...
            <div class="space-y-2" id="dateOfBirth">
                ...
                <DatePicker
                    ...
                    month-year-selector
                />
                <p v-if="validationErrors.dateOfBirth" class="mt-1 text-sm text-red-600">
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
            ...
            <div class="space-y-2">
                ...
                <Input id="photo" type="file" accept="image/*" @change="$emit('photo-change', $event)" />
            </div>
            ...
            <div class="space-y-2" id="joinedDate">
                ...
                <DatePicker
                    ...
                    month-year-selector
                />
                <p v-if="validationErrors.joinedDate" class="mt-1 text-sm text-red-600">
        ...
        <div class="mt-6 space-y-6">
            <div class="flex items-center justify-between">
                ...
                <Button type="button" variant="outline" size="sm" @click="addGuardian" class="flex cursor-pointer items-center gap-2">
                    <Plus class="h-4 w-4" />
                    Add Guardian
                </Button>
            </div>

            <div v-for="(guardian, index) in guardians" :key="index" class="relative space-y-5 rounded-lg border bg-gray-50 p-5">
                ...
                <Button
                    ...
                    variant="ghost"
                    size="icon"
                    class="absolute top-2 right-2 cursor-pointer text-red-600 hover:bg-red-50 hover:text-red-700"
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                    <!-- Guardian Name -->
                    <div class="space-y-2">
                        <Label :for="`guardian-name-${index}`"> Name <span class="text-red-500">*</span> </Label>
                        <Input
                        ...
                        />
                        <p v-if="validationErrors[`guardians.${index}.guardianname`]" class="mt-1 text-sm text-red-600">
                    ...
                    <!-- Relation -->
                    <div class="space-y-2">
                        <Label :for="`guardian-relation-${index}`"> Relation <span class="text-red-500">*</span> </Label>
                        <Input
                        ...
                        />
                        <p v-if="validationErrors[`guardians.${index}.relation`]" class="mt-1 text-sm text-red-600">
                    ...
                    <!-- Phone -->
                    <div class="space-y-2">
                        <Label :for="`guardian-phone-${index}`"> Phone <span class="text-red-500">*</span> </Label>
                        <Input
                        ...
                        />
                        <p v-if="validationErrors[`guardians.${index}.phone`]" class="mt-1 text-sm text-red-600">
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                    ...
                    <div class="space-y-2">
                        ...
                        />
                        <p v-if="validationErrors[`guardians.${index}.email`]" class="mt-1 text-sm text-red-600">
                    ...
                    <div class="space-y-2">
                        ...
                        <Input :id="`guardian-occupation-${index}`" v-model="guardian.occupation" placeholder="e.g. Teacher, Engineer" />
                    </div>
                    ...
                    <div class="flex items-end space-y-2">
                        <div class="flex items-center gap-2 pb-2">
                            ...
                            />
                            <Label :for="`guardian-primary-${index}`" class="cursor-pointer font-normal"> Primary Contact </Label>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <Input :id="`guardian-address-${index}`" v-model="guardian.address" placeholder="Enter full address" />
                </div>
            </div>
        </div>

        <!-- Submit Button -->
        <Button type="submit" class="float-right mt-4" :tabindex="4" :disabled="form.processing">
