...
export function useFormValidation(form: any) {
    ...
    const validateField = (fieldName: string): boolean => {
        ...
        // Required validation
        if (rule.required) {
            if (!value || (typeof value === 'string' && value.trim() === '') || (typeof value === 'object' && value === null)) {
        ...
        if ((rule.min !== undefined || rule.max !== undefined) && value && typeof value === 'string') {
            ...
            if (isNaN(numValue) || (rule.min !== undefined && numValue < rule.min) || (rule.max !== undefined && numValue > rule.max)) {
                if (showValidation.value) {
                    validationErrors.value[fieldName] = rule.message;
                }
                return false;
